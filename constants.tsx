...
export const MOCK_DATA: VendorData = {
    ...
    teamMembers: [
        ...
        { id: TEAM_6_ID, name: 'Eka Wijaya', role: 'Pilot Drone', email: 'eka.w@freelance.com', phone: '086666666666', standardFee: 1200000, noRek: 'M-Bank 789789789', rewardBalance: 100000, rating: 4.8, performanceNotes: [], portalAccessId: 'freelancer-eka-wijaya' },
    ],
    projects: [
